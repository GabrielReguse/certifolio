...
export const profileInputSchema = z.object({
  ...
  bannerPositionX: z.number().int().min(0).max(100).optional().default(50),
  bannerPositionY: z.number().int().min(0).max(100).optional().default(50),
  bannerZoom: z.number().int().min(100).max(180).optional().default(100),
  profileVisibility: z.enum(['public', 'unlisted', 'private']),
